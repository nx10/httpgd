...
namespace httpgd
{
    ...
    HttpgdDev::HttpgdDev(pDevDesc t_dd, const std::string &t_host, int t_port, const Rcpp::List &t_aliases, double t_width, double t_height, bool t_recording)
        : dd(t_dd),
          server(t_host, t_port, t_width, t_height, t_recording),
