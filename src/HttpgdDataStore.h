...
namespace httpgd
{
    ...
    public:
        ...
        std::string api_state_json(std::shared_ptr<HttpgdServerConfig> config, const std::string &host);
        std::string api_state_json(std::shared_ptr<HttpgdServerConfig> config, int port);
